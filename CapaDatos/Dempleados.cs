   ...
   public class Dempleados
    {
        ...
        public Dempleados(int idtrabajador, string nombre, string apellidos, string sexo,
        ...
        public string Editar(Dempleados Empleados)
        {
            ...
            try
            {
                ...
                ParIdtrabajador.ParameterName = "@idtrabajador";
                ParIdtrabajador.SqlDbType = SqlDbType.Int;
                ParIdtrabajador.Value = Empleados.Idtrabajador;
                SqlCmd.Parameters.Add(ParIdtrabajador);
        ...
        public DataTable BuscarNum_Documento(Dempleados Trabajador)
        {
            DataTable DtResultado = new DataTable("trabajador");
            SqlConnection SqlCon = new SqlConnection();
            try
        ...
        public DataTable Login(Dempleados Trabajador)
        {
            DataTable DtResultado = new DataTable("trabajador");
            SqlConnection SqlCon = new SqlConnection();
            try
